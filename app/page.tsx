...
const productsData = [
  ...
  },
  {
    ...
    description: "Oversized Sweatshirts",
    color: [
  ...
  },
  {
    ...
    description: "Classic Fit Knitted Crew Neck Sweater",
    color: [
  ...
  },
  {
    ...
    description: "Cropped Sweatshirt",
    color: [
  ...
  },
  {
    ...
    description: "Micro-Rib Tank Top",
    color: [
  ...
  },
  {
    ...
    description: "Relaxed V-Neck T-Shirt",
    color: [
...
export default function Home() {
  ...
  return (
    <main className="bg-[white] px-5  max-w-[100vw] w-[100vw] min-h-[100vh] max-h-[100vh] h-auto flex flex-col relative overflow-scroll space-y-10 text-[#272343] text-sm">
